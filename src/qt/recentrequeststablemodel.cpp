    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return ProofOfGamingUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, ProofOfGamingUnits::separatorNever);
            else
                return ProofOfGamingUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+ProofOfGamingUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
