...
#include "qt/proofofgamingamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ProofOfGamingAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_proofofgaming-qt -platform xcb      # Linux
//     src/qt/test/test_proofofgaming-qt -platform windows  # Windows
//     src/qt/test/test_proofofgaming-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = ProofOfGamingUnits::formatWithUnit(unit, balance, false, ProofOfGamingUnits::separatorAlways);
    ...
    // Amount input
    ProofOfGamingAmountField* amountInput = receiveCoinsDialog.findChild<ProofOfGamingAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: proofofgaming:")) != -1);
