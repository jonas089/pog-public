...
/** ProofOfGaming unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ProofOfGamingUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ProofOfGamingUnits(QObject *parent);

    /** ProofOfGaming units.
      @note Source: https://en.proofofgaming.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        POG,
...
typedef ProofOfGamingUnits::Unit ProofOfGamingUnit;
