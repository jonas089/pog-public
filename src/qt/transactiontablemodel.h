...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, ProofOfGamingUnits::SeparatorStyle separators=ProofOfGamingUnits::separatorStandard) const;
