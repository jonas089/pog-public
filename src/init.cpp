 ...
 * between proofofgamingd, and proofofgaming-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("proofofgaming-shutoff");
    ...
    FlushWallets();
#endif
    GenerateProofOfGamings(false, 0, Params());
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ProofOfGamingProject/ProofOfGamingcoin>";
    const std::string URL_WEBSITE = "<https://proofofgamingcoin.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("proofofgaming-loadblk");
...
/** Sanity checks
 *  Ensure that ProofOfGaming is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("ProofOfGaming version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single ProofOfGaming process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    GenerateProofOfGamings(fGenerate, gArgs.GetArg("-genproclimit", DEFAULT_GENERATE_THREADS), chainparams);
