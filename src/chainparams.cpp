...
// Copyright (c) 2009-2016 The ProofOfGaming Core developers
...
{
    const char* pszTimestamp = "Genesis Block 17.04.2019 at 13:43 pm";
...
public:
    CMainParams() {
        ...
        consensus.nPowDifficultyRetargetHeight = 100000; // blockheight to switch to 360 block retarget rules
	...
	consensus.fPowAllowMinDifficultyBlocks = false;
        ...
        genesis = CreateGenesisBlock(1555501756, 8407961, 0x1e00ffff, 4, 5000 * COIN);
...
//////////////
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000063626efed75d215e199f8d136ca896e7ae88c925d1ee5aebfbe7fdd2e1")); //0x
        assert(genesis.hashMerkleRoot == uint256S("0x45647e1bedbaad01e90f66e3a4b93ec1c16d0fa8bb7b17b199bf02595ce1b810")); //0x
...
/*
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the ProofOfGaming chain
...
public:
    CTestNetParams() {
       ...
       // assert(genesis.hashMerkleRoot == uint256S("0xf0cc5f92b11a6655a4939fc239e8bf960cd0453b87b5a0820ab36904279341a5"));
        ...
        vSeeds.emplace_back("test-seed.proofofgamingcoin.org", false);
