...
{
    RenameThread("proofofgaming-http");
...
{
    RenameThread("proofofgaming-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/ProofOfGamingProject/ProofOfGamingcoin/pull/6990)
