...
By default, proofofgamingd will dump mempool on shutdown and
...
class MempoolPersistTest(ProofOfGamingTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give proofofgamingd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent proofofgamingd from writing mempool.dat to disk. Verify that `savemempool` fails")
