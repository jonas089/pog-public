...
Also test that nodes that send unsupported service bits to proofofgamingd are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if proofofgamingd ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
...
class P2PLeakTest(ProofOfGamingTestFramework):
