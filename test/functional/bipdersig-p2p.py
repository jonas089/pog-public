...
class BIP66Test(ProofOfGamingTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # proofofgamingd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and proofofgamingd produces more specific reject
            # reasons.
