...
class TxnMallTest(ProofOfGamingTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 POG:
        ...
        # First: use raw transaction API to send 1240 POG to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 POG coin each
        ...
        # Node0's balance should be starting balance, plus 50POG for another
        ...
        # Node0's total balance should be starting balance, plus 100POG for 
