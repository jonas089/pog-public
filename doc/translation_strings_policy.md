...
This document provides guidelines for internationalization of the ProofOfGaming Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `proofofgaming_en.ts` remains unchanged.
